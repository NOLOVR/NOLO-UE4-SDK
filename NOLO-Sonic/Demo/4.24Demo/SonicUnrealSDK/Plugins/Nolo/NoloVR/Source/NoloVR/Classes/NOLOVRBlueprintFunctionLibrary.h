...
public:
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "NOLO VR")
		static bool HapticWithAudioFileLoop(FString path, int channel_number, int loopCount);

	//UFUNCTION(BlueprintCallable, Category = "NOLO VR")
		static bool HapticWithConfig(float strength,int filtering,int channel_number);

	//UFUNCTION(BlueprintCallable, Category = "NOLO VR")
		static bool Action(FString actionJson);
