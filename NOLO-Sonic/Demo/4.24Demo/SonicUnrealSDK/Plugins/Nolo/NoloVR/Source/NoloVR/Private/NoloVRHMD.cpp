...
bool FNoloVRHMD::HapticWithAudioFileLoop(char* path, int channel_number, int loopCount)
{
	return  noloVrApi.get()->HapticWithAudioFileLoop(path,channel_number,loopCount);
}
...
bool FNoloVRHMD::HapticWithConfig(float strength, int filtering, int channel_number)
{
	return  noloVrApi.get()->HapticWithConfig(strength, filtering,channel_number);
}

bool FNoloVRHMD::Action(char* actionJson)
{
	return  noloVrApi.get()->Action(actionJson);
}
